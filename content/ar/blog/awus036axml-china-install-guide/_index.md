---
title: "دليل تثبيت برنامج تشغيل ALFA AWUS036AXML للصين: Kali Linux، Ubuntu، Debian و Raspberry Pi"
description: "دليل خطوة بخطوة لتثبيت برامج تشغيل ALFA AWUS036AXML في الصين باستخدام المرايا المحلية. برنامج تشغيل MT7921AUN WiFi 6E المدمج في النواة، دعم كامل لوضع المراقبة و VIF. يغطي Kali Linux و Ubuntu 22/24 و Debian و Raspberry Pi. لا يتطلب GitHub."
date: 2026-04-24
draft: false
...
1. محول **ALFA AWUS036AXML** وكبل USB-C
...
إذا لم تره، جرب منفذ USB-C أو كبلًا مختلفًا، ثم قم بتشغيل `lsusb` مرة أخرى.
...
> يستهلك AWUS036AXML ما يصل إلى 2.7 واط تحت الحمل. استخدم دائمًا موزع USB يعمل بالطاقة على Raspberry Pi.
...
في Pi مع Wi-Fi مدمج، يظهر AWUS036AXML كـ `wlan1`.
...
|---------|-------------|-----|
| `lsusb` لا يظهر 0e8d:7961 | المحول غير متصل أو الكبل تالف | جرب منفذ USB-C أو كبلًا مختلفًا. استخدم موزعًا يعمل بالطاقة على Raspberry Pi. |
...
- [دليل تثبيت AWUS036AXM في الصين](/ar/blog/awus036axm-china-install-guide/) — MT7921AUN، شكل L موفر للمساحة
- AWUS036AXML ← أنت هنا
