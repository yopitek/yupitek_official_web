...
الأخت الكبرى للـ RTL8812AU: MIMO 4×4، 802.11ac، ثنائية النطاق. مدعومة ببرنامج تشغيل `rtl8814au`. أداء ممتاز في بيئات ذات كثافة عالية من نقاط الوصول حيث تُحسّن الإشارة الأقوى جودة الالتقاط. دعم حقن كامل.
...
شريحة كلاسيكية أحادية النطاق (2.4 GHz) بتاريخ طويل في أدوات أمان الشبكات اللاسلكية. برنامج التشغيل `ath9k_htc` مدمج في النواة ومُختبر جيداً. دعم الحقن صلب ومتسق عبر إصدارات النواة. رغم أنها تغطي 2.4 GHz فقط، لا تزال خياراً موثوقاً لاختبار الشبكات القديمة.
...
| AWUS036AXML | MT7921AU | 2.4 / 5 / 6 GHz | ✅ كامل (نواة 5.18+) |
| AWUS036ACM | MT7612U | 2.4 / 5 GHz | ✅ كامل |
| AWUS036NHA | AR9271 | 2.4 GHz | ✅ كامل |
| AWUS036NH | RTL8187 | 2.4 GHz | ✅ كامل |
| AWUS1900 | RTL8814AU | 2.4 / 5 GHz | ✅ كامل |
