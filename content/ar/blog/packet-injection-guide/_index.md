...
lastmod: 2026-07-02
faq:
  - question: "ما هو حقن حزم WiFi؟"
    answer: "حقن الحزم هو قدرة المحول على إرسال إطارات 802.11 عشوائية مباشرة إلى الوسط اللاسلكي، مما يتيح لأدوات مثل aireplay-ng بناء وإرسال إطارات إدارة وتحكم وبيانات."
  - question: "لماذا لا تستطيع معظم المحولات حقن الحزم؟"
    answer: "القيد في التعريف لا العتاد. التعريفات الاستهلاكية تتحقق من الإطارات الصادرة وفق نموذج التشغيل القياسي، ويلزم أن يُفعّل التعريف صراحةً مسار TX الخام في mac80211 لدعم الحقن."
  - question: "كيف أختبر دعم المحول لحقن الحزم؟"
    answer: "فعّل وضع المراقبة أولاً، ثم نفّذ aireplay-ng --test wlan0mon. إذا أظهر المخرج Injection is working! فالحزم مدعومة. نسبة نجاح 80% فأكثر تعتبر موثوقة."
  - question: "ما محولات ALFA التي تدعم حقن الحزم؟"
    answer: "AWUS036ACH (RTL8812AU) و AWUS036AXML (MT7921AUN) و AWUS036ACM (MT7612U) جميعها تدعمه بالكامل. مع التعريف الصحيح تعمل على Kali Linux."
  - question: "كيف أحسن نسبة نجاح اختبار الحقن إذا كانت أقل من 50%؟"
    answer: "اقترب من AP الهدف، اضبط واجهة المراقبة على نفس القناة، تحقق من إعداد TX Power، وتأكد أن التعريف هو إصدار aircrack-ng وليس إصدار التوزيعة المدمج."
---
{{< tldr >}}
حقن الحزم قدرة المحول على إرسال إطارات 802.11 عشوائية، قيده في التعريف لا العتاد. محولات ALFA بشرائح RTL8812AU و MT7612U و MT7921AUN مع تعريف aircrack-ng تدعمها بالكامل.
{{< /tldr >}}
...
1. [موقع وثائق aircrack-ng الرسمية](https://www.aircrack-ng.org/)
2. [دليل استخدام aireplay-ng](https://www.aircrack-ng.org/doku.php?id=aireplay-ng)
3. [وثائق Kali Linux الرسمية](https://www.kali.org/docs/)
4. [وثائق نظام Linux mac80211 الفرعي](https://wireless.wiki.kernel.org/en/developers/Documentation/mac80211)
5. [موارد معيار IEEE 802.11](https://standards.ieee.org/ieee/802.11/)
