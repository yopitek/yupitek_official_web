...
- **AWUS036AXML** — ضروري لشبكات WPA3 على Wi-Fi 6E (6 GHz). شريحة Mediatek MT7921AU. دعم كامل لوضع المراقبة والحقن على Kali Linux مع نواة 5.18+. المحول ALFA الوحيد الذي يغطي قنوات 6 GHz حيث تتزايد عمليات نشر WPA3-only.
