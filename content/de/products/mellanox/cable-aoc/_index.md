---
title: "NVIDIA Mellanox LinkX AOC-Aktive-Optische-Kabel"
description: "Aktive optische Kabel (AOC) mit hoher Dichte. Wählen Sie Mellanox 100G QSFP28 und 200G QSFP56 AOC-Konfigurationen für große Reichweiten und dichte Server-Rack-Verbindungen."
date: 2026-05-27
draft: false
...
<div style="display: flex; flex-wrap: wrap; gap: 1.5rem; margin: 1.5rem 0;">
  <div style="flex: 1 1 300px; max-width: 48%; text-align: center;">
    ...
    <p style="font-size: 0.85rem; color: #9ca3af; margin-top: 0.5rem;">NVIDIA Mellanox 100G QSFP28 aktives optisches Kabel</p>
  </div>
  <div style="flex: 1 1 300px; max-width: 48%; text-align: center;">
    ...
    <p style="font-size: 0.85rem; color: #9ca3af; margin-top: 0.5rem;">NVIDIA 200G QSFP56 aktives optisches Kabel</p>
  </div>
</div>
