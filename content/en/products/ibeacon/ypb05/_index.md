...
description: "YPB05 Micro USB Bluetooth Beacon. Features battery-free operation powered by any USB slot, 50m range, ultra-lightweight (2.0g), plug-and-play design for retail promotion and indoor location."
date: 2026-06-04
draft: false
...
The **YPB05** is an ultra-compact, battery-free Bluetooth® Low Energy (BLE 5.0) beacon powered directly by any standard micro USB or USB port. Weighing only **2.0g** and measuring **18 × 14 × 6 mm**, it is a highly portable, plug-and-play solution.
...
{{< gallery >}}
  <img src="/images/products/ibeacon/ypb05.png" alt="Yupitek YPB05 Micro USB BLE 5.0 Beacon" />
{{< /gallery >}}
