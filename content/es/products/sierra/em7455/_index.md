...
| **Tecnología Celular** | 4G LTE-Advanced Cat 6 (支援 3G 回落) |
| **Chipset** | Qualcomm MDM9230 |
| **Velocidades Máximas** | 300 Mbps / 50 Mbps |
| **Bandas LTE** | B1, B2, B3, B4, B5, B7, B8, B12, B13, B20, B25, B26, B29, B30, B41 |
| **UMTS / 3G 頻段** | B1 (2100), B2 (1900), B3 (1800), B4 (AWS), B5 (850), B8 (900) |
| **Factor de Forma** | M.2 Type 3042-S3-B (42 × 30 × 2.3 mm) |
| **Interfaces del Host** | USB 3.0, USB 2.0, PCIe |
| **電信認證** | AT&T, Verizon, T-Mobile, Sprint, Vodafone, Rogers, Bell, Telus |
| **天線接頭** | IPEX MHF-4 |
| **Temperatura de Operación** | -40°C ~ +85°C |

## Soporte de SO y Controladores

| Sistema Operativo | Estado de Soporte | Notas |
|:---|:---|:---|
| **Windows 10 / 11** | ✅ Soportado | Controladores oficiales Windows MBIM / QMI y gestor Skylight |
| **Linux** | ✅ Soportado | Controladores qmi_wwan / cdc_mbim integrados en kernel Linux |
| **Android** | ✅ Soportado | Controladores de integración Android RIL proporcionados |
