...
Les liens ci-dessous pointent vers la base de ressources techniques officielle de Sierra Wireless (source.sierrawireless.com). **Certains documents nécessitent une connexion membre pour télécharger le PDF** — les chiffres de cet article sont compilés à partir des données publiquement accessibles. Si tu as besoin des valeurs exactes à vérifier ligne par ligne (notamment les pics montants des EM9190/EM9191), contacte-nous pour obtenir les documents officiels :
