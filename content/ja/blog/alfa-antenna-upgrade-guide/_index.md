...
lastmod: 2026-07-02
faq:
  - question: "ALFAアダプターのアンテナは自分で交換できますか？"
    answer: "できます。RP-SMAコネクタを備えたALFAアダプター（AWUS036ACH、AWUS036ACM、AWUS036AXMLなど）はすべてアンテナ交換可能で、工具不要、反時計回りに回して外し時計回りに取り付けるだけです。"
  - question: "RP-SMAコネクタとは何ですか？"
    answer: "RP-SMAは逆極性SMAコネクタで、オス側の中央がピンではなくソケットになっており、標準SMAと極性が逆ですが外見は似ています。ALFAのすべてのアクセサリーアンテナがこの規格を採用しています。"
  - question: "指向性アンテナとオムニ方向アンテナのどちらを選ぶべきですか？"
    answer: "指向性アンテナは目標方向が分かっている定点監査に適し、オムニ方向アンテナは移動巡回や目標位置が不明なシーンに適しています。使用環境に応じて選んでください。"
  - question: "APA-M25とARS NT5B7の違いは？"
    answer: "APA-M25は7 dBi指向性パネルアンテナで室内の絞り込みテストに適し、ARS NT5B7は5/7 dBiオムニ方向アンテナで室内外兼用です。前者は方向性が高く、後者はカバレッジが広いです。"
  - question: "アンテナ交換にドライバーインストールや設定は必要ですか？"
    answer: "不要です。アンテナ交換は純粋なハードウェア交換で、ドライバー更新、設定、再起動なしで、取り付け完了後すぐに新しいアンテナで動作します。"
---
...
{{< tldr >}}
ALFAアダプターはすべてRP-SMAコネクタを採用し、5種類のアンテナアクセサリーがシングルバンドからトライバンド、指向性からオムニ方向までカバーします。工具不要で30秒以内に取り付けでき、交換後に信号強度が4〜8 dBm向上します。
{{< /tldr >}}
**標準スティックアンテナの特徴：**
...
1. [ALFA Network公式ウェブサイト — アンテナアクセサリー製品ライン](https://www.alfa.com.tw/)
2. [Linux Wireless — mac80211無線ドライバーアーキテクチャドキュメント](https://wireless.wiki.kernel.org/en/developers/documentation/mac80211)
3. [IEEE 802.11標準ドキュメント — 無線LAN規格](https://standards.ieee.org/ieee/802.11/)
4. [aircrack-ng — 無線セキュリティツールスイート公式ウェブサイト](https://www.aircrack-ng.org/)
5. [FCC Part 15 — 免許不要無線機器規定](https://www.fcc.gov/engineering-technology-laboratory-division/general/radio-spectrum-and-rulemaking)
