...
RTL8812AU の上位モデル：4×4 MIMO、802.11ac、デュアルバンド。`rtl8814au` ドライバーでサポート。AP 密度が高い環境でより強い電波強度によりキャプチャ品質が向上します。完全なインジェクションサポートを持ちます。
...
長い無線セキュリティツールの歴史を持つクラシックなシングルバンド（2.4 GHz）チップセット。`ath9k_htc` ドライバーはカーネル内蔵で実績十分。インジェクションサポートはカーネルバージョンをまたいで堅牢かつ一貫しています。2.4 GHz のみのカバレッジですが、レガシーネットワークテストの信頼できる選択肢であり続けています。
...
| AWUS036NHA | AR9271 | 2.4 GHz | ✅ 完全対応 |
| AWUS036NH | RTL8187 | 2.4 GHz | ✅ 完全対応 |
| AWUS1900 | RTL8814AU | 2.4 / 5 GHz | ✅ 完全対応 |
