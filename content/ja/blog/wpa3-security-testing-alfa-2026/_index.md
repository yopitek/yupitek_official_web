...
- **AWUS036AXML** — Wi-Fi 6E（6 GHz）WPA3ネットワークに必須。Mediatek MT7921AUチップセット。カーネル5.18以降のKali Linuxでの完全なモニターモードとインジェクションサポート。WPA3のみの展開がますます一般的になっている6 GHzチャンネルをカバーする唯一のALFAアダプター。
