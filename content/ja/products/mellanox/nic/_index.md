...
互換性のあるケーブルをお探しですか？弊社の[ダイレクトアタッチケーブル（DAC）製品一覧](/ja/products/mellanox/cable-dac/)および[アクティブ光ケーブル（AOC）製品一覧](/ja/products/mellanox/cable-aoc/)をご覧ください。価格や在庫状況については、[お問い合わせフォーム](/ja/contact/)よりお気軽にお問い合わせください。
