---
title: "Flipper Zero — Dispositivo Multi-Protocolo de Pesquisa Sem Fio"
description: "Yopitek distribui Flipper Zero com suporte para Sub-GHz, NFC, RFID, infravermelho, Bluetooth. Ideal para educação em segurança e pesquisa legal."
date: 2026-03-12
draft: false
...
{{< alert "warning" >}}
**Aviso de uso legal**: Flipper Zero é para pesquisa de segurança autorizada, educação e testes legais apenas. A clonagem não autorizada de cartões de acesso ou acesso a sistemas de terceiros é ilegal.
{{< /alert >}}
