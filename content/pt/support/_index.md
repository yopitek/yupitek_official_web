...
<div class="my-6">
  <input
    type="text"
    id="driver-search"
    placeholder="Pesquisar modelo, ex.: AWUS036ACH"
...
| Recurso | Link |
|------|------|
| Documentação online do HAK5 | [docs.hak5.org](https://docs.hak5.org/hak5-docs/) |
| Downloads de software HAK5 | [downloads.hak5.org](https://downloads.hak5.org/) |
| Fórum da comunidade HAK5 | [hak5.org/community](https://hak5.org/pages/community) |

## Software Flipper Zero

Visite a [página oficial de downloads do Flipper Zero](https://flipper.net/pages/downloads) para obter o software mais recente.
