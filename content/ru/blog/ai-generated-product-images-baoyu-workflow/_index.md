...
faq:
  - question: "Что такое baoyu-skills?"
    answer: "baoyu-skills — коллекция плагинов с открытым исходным кодом для GitHub Copilot CLI, предоставляющая 19 навыков для генерации изображений, вывода HTML, перевода и публикации в соцсетях, всё доступно прямо из терминала."
  - question: "Какой навык подходит для создания обложек статей блога?"
    answer: "baoyu-cover-image разработан специально для обложек статей и поддерживает три формата: кинематографический 2.35:1, широкоэкранный 16:9 и квадратный 1:1 с различными цветовыми палитрами и стилями рендеринга."
  - question: "Как использовать baoyu-skills в GitHub Copilot CLI?"
    answer: "После установки плагинов введите в терминале команды вроде /baoyu-cover-image или /baoyu-xhs-images, и навык проведёт вас через уточняющие вопросы о стиле, размерах и содержании перед генерацией."
  - question: "Какие типы графического вывода поддерживает baoyu-skills?"
    answer: "Тип A охватывает обложки, инфографику, комиксы, слайды, рендеры продуктов и вертикальные карточки XHS; Тип B создаёт стилизованный HTML; Тип C обрабатывает перевод и публикацию в соцсетях."
  - question: "Как применить baoyu-skills к собственному продукту?"
    answer: "Найдите в статье вариант, соответствующий тональности вашего бренда, скопируйте промпт и замените название продукта и ключевые характеристики на данные вашего продукта, затем запустите навык в Copilot CLI."
---
...
{{< tldr >}}
baoyu-skills предоставляет 19 навыков для вывода изображений, HTML и текста. В статье на примере ALFA AWUS036ACM показаны варианты стилей, промпты и сценарии применения для 6 графических навыков.
{{< /tldr >}}
...
1. [Репозиторий baoyu-skills на GitHub](https://github.com/JimLiu/baoyu-skills.git)
2. [Официальная документация GitHub Copilot CLI](https://docs.github.com/en/copilot/github-copilot-in-the-cli)
3. [Технические характеристики ALFA Network AWUS036ACM](https://www.alfa.com.tw/)
4. [Информация о чипсете MediaTek MT7612U](https://www.mediatek.com/products/networking-and-connectivity)
5. [Документация OpenAI Image Generation API](https://platform.openai.com/docs/guides/images)
