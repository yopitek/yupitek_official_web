...
faq:
  - question: "Для чего нужен Black Duck FuzzBox?"
    answer: "Black Duck FuzzBox — специализированная среда для фаззинга беспроводных протоколов, проверяет надёжность стека протоколов встроенных беспроводных устройств и точек доступа путём инъекции аномальных 802.11-кадров."
  - question: "Почему WiFi 6/6E-адаптеры не работают с FuzzBox?"
    answer: "Движок инъекции FuzzBox оптимизирован под драйвер Realtek rtl88xxau. Чипсеты MediaTek и более новые Realtek WiFi 6 не используют эту ветку и игнорируются мастером настройки."
  - question: "Почему ALFA AWUS036ACH — выбор для FuzzBox?"
    answer: "AWUS036ACH (RTL8812AU) имеет оптимизированный драйвер инъекции от сообщества, может обходить сетевой стек ОС для передачи raw-кадров без потерь."
  - question: "На каком Linux-дистрибутиве основан FuzzBox OS?"
    answer: "FuzzBox OS основан на Debian 12 Bookworm, работает на ядре LTS 6.1.x, предустановлены драйвер инъекции rtl88xxau и сетевые инструменты, включая airmon-ng."
  - question: "Как проверить, что AWUS036ACH переключён в режим монитора?"
    answer: "Выполните iwconfig wlan0, вывод должен показать Mode:Monitor и текущую частоту, подтверждая успешное переключение режима интерфейса мастером FuzzBox."
---
...
{{< tldr >}}
ALFA AWUS036ACH — единственный выбор для фаззинга протоколов Black Duck FuzzBox. Драйвер RTL8812AU поддерживает сырую инъекцию пакетов и режим монитора. WiFi 6/6E-адаптеры не работают из-за несовместимости драйверов.
{{< /tldr >}}
...
1. [Synopsys Defensics — официальная страница продукта FuzzBox](https://www.synopsys.com/software-integrity/security-testing/fuzzing/defensics.html)
2. [morrownr/8812au-20210629 — репозиторий драйвера RTL8812AU на GitHub](https://github.com/morrownr/8812au-20210629)
3. [Официальный сайт aircrack-ng](https://www.aircrack-ng.org/)
4. [Официальный сайт ALFA Network](https://www.alfa.com.tw/)
5. [Linux Wireless — документация подсистемы mac80211](https://wireless.wiki.kernel.org/en/developers/documentation/mac80211)
