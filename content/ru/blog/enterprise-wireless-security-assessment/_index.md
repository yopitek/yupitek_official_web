...
faq:
  - question: "Какие этапы включает корпоративная оценка безопасности беспроводных сетей?"
    answer: "Полная оценка охватывает шесть последовательных этапов: пассивная разведка, обнаружение rogue AP, анализ рукопожатия WPA2/WPA3, проверка PMF, тестирование изоляции клиентов и оценка EAP/RADIUS."
  - question: "Какие разрешения нужны для проведения оценки безопасности беспроводных сетей?"
    answer: "Необходимо получить письменное разрешение, подписанное CISO или владельцем активов, чётко определяющее окно тестирования, MAC-адреса устройств и авторизованные технические методы, устного согласия недостаточно."
  - question: "Как обнаружить rogue AP?"
    answer: "Сравните список BSSID, полученный при пассивной разведке, с авторизованным списком AP. Любой BSSID, транслирующий корпоративный SSID, но не входящий в список, является кандидатом на rogue AP."
  - question: "Почему важен PMF (Protected Management Frames)?"
    answer: "PMF предотвращает атаки deauth и disassociation, не позволяя злоумышленникам принудительно отключать клиентов для перехвата рукопожатия или DoS. В WPA3 PMF является обязательным требованием."
  - question: "Какие риски у переходного режима WPA3?"
    answer: "Переходный режим WPA3 одновременно принимает аутентификацию SAE и PSK для совместимости. Злоумышленник может транслировать beacon только с WPA2, заставляя клиента понизить уровень безопасности."
---
...
{{< tldr >}}
Этот фреймворк на основе адаптеров ALFA подробно описывает шестиэтапную методологию корпоративной оценки безопасности беспроводных сетей: определение области, обнаружение rogue AP, аудит WPA2/WPA3, тестирование PMF, изоляция клиентов и оценка 802.1X.
{{< /tldr >}}
...
2. [Спецификация Wi-Fi Alliance WPA3](https://www.wi-fi.org/discover-wi-fi/wpa3)
3. [Стандарт IEEE 802.11w Protected Management Frames](https://standards.ieee.org/ieee/802.11w/4454/)
4. [NIST SP 800-153 Руководство по безопасности беспроводных сетей](https://csrc.nist.gov/publications/detail/sp/800-153/final)
5. [Инструмент обнаружения беспроводных сетей Kismet](https://www.kismetwireless.net/)
