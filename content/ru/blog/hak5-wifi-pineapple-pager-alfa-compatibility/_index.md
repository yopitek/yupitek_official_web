...
- **Для быстрого развертывания и максимальной стабильности**: Приобретайте [ALFA AWUS036ACM](https://yupitek.com/en/products/alfa/awus036acm). Драйверы MediaTek для него встроены в ядро OpenWrt 6.6 нативно и работают безупречно из коробки.
