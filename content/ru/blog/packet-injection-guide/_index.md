...
Старший брат RTL8812AU: MIMO 4×4, 802.11ac, двухдиапазонный. Поддерживается драйвером `rtl8814au`. Отличен для окружений с высокой плотностью точек доступа, где более сильный сигнал улучшает качество захвата. Полная поддержка инъекции.
...
Классический однодиапазонный (2,4 ГГц) чипсет с долгой историей в инструментах беспроводной безопасности. Драйвер `ath9k_htc` встроен в ядро и хорошо проверен. Поддержка инъекции надёжна и стабильна от версии к версии ядра. Несмотря на охват только 2,4 ГГц, по-прежнему является надёжным выбором для тестирования устаревших сетей.
...
| AWUS036NHA | AR9271 | 2,4 ГГц | ✅ Полная |
| AWUS036NH | RTL8187 | 2,4 ГГц | ✅ Полная |
| AWUS1900 | RTL8814AU | 2,4 / 5 ГГц | ✅ Полная |
