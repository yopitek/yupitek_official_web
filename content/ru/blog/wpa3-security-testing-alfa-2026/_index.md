...
- **AWUS036AXML** — Необходим для сетей WPA3 Wi-Fi 6E (6 ГГц). Чипсет Mediatek MT7921AU. Полная поддержка режима мониторинга и инъекций в Kali Linux с ядром 5.18+. Единственный адаптер ALFA, охватывающий каналы 6 ГГц, где развёртывания только с WPA3 становятся всё более распространёнными.
