...
faq:
  - question: "В чём отличия WPA3 от WPA2 при тестировании безопасности?"
    answer: "WPA3 использует рукопожатие SAE вместо PSK, обеспечивает прямую секретность и устойчив к офлайн-словарным атакам. PMF обязателен, но переходный режим создаёт поверхность для атак на понижение уровня."
  - question: "Можно ли офлайн-взломать после захвата рукопожатия SAE?"
    answer: "Нет. Чистые SAE-сети не генерируют взламываемые хэши. Захват SAE-кадров используется только для анализа уровня протокола, подтверждения корректного варианта и согласования PMF."
  - question: "Что такое атака на понижение уровня в переходном режиме WPA3?"
    answer: "AP в переходном режиме одновременно принимает SAE и PSK. Злоумышленник создаёт поддельный AP только с WPA2, если клиент не требует SAE, происходит понижение уровня, рукопожатие можно взломать офлайн."
  - question: "Нужен ли адаптер 6 ГГц для тестирования WPA3?"
    answer: "Только для тестирования сетей WPA3 в диапазоне 6 ГГц нужен AWUS036AXML. Для тестирования WPA3 на 2.4/5 ГГц достаточно AWUS036ACH."
  - question: "Нужно ли ещё тестировать уязвимости Dragonblood?"
    answer: "Современные прошивки AP в основном исправлены, но в средах со старым или неисправленным ПО всё ещё нужно тестировать боковые атаки CVE-2019-9494 и SAE commit flood DoS."
---
...
{{< tldr >}}
Тестирование безопасности WPA3 охватывает анализ рукопожатия SAE, атаки на понижение уровня в переходном режиме, оценку уязвимостей Dragonblood и принудительное включение PMF. AWUS036AXML для тестирования 6 ГГц, AWUS036ACH для 2.4/5 ГГц.
{{< /tldr >}}
...
1. [Официальная исследовательская работа Dragonblood (Vanhoef & Ronen, 2019)](https://papers.mathyvanhoef.com/dragonblood.pdf)
2. [Сертификация Wi-Fi Alliance WPA3](https://www.wi-fi.org/discover-wi-fi/wpa3)
3. [Официальная документация aircrack-ng](https://www.aircrack-ng.org/documentation.html)
4. [Документация инструмента hcxdumptool](https://github.com/ZerBea/hcxdumptool)
5. [Стандарт IEEE 802.11w PMF](https://standards.ieee.org/ieee/802.11/)
