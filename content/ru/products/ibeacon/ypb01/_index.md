---
title: "Маяк YPB01 BLE 5.0 (低功耗藍牙)"
description: "Маяк YPB01 BLE 5.0 (低功耗藍牙). Bluetooth Low Energy BLE 5.0 (低功耗藍牙), для позиционирования, контроля присутствия и трекинга."
date: 2026-06-04
draft: false
