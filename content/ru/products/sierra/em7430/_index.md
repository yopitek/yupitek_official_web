...
| **Интерфейс SIM** | 雙 SIM 卡切換支援 (1.8V / 3.0V) |
| **天線介面** | IPEX MHF-4 接頭 (主天線、分集天線、MIMO、GNSS) |
| **Рабочая температура** | -40°C ~ +85°C (工業級) |
...
| **Linux (Ubuntu / Debian / RHEL)** | ✅ Поддерживается | Встроенные драйверы ядра Linux qmi_wwan / cdc_mbim |
