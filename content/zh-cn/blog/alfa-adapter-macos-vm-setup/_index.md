...
**AWUS036ACH（RTL8812AU）与 AWUS036ACM（MT7612U）— 需要第三方 macOS 驱动程序的网卡：** 这些网卡在 macOS 上需要第三方驱动程序。社区和商业驱动套件都有，但兼容性不稳定。macOS 小版本更新后常需重新安装驱动程序，macOS 11 起内核扩展签名要求更加严格，而在 Apple Silicon 上由于 Rosetta 对内核扩展的限制，情况更加脆弱。
