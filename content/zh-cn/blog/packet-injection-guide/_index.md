...
RTL8812AU 的增强版：4×4 MIMO 天线阵列、802.11ac、双频支持，由 `rtl8814au` 驱动程序驱动。在接入点密度较高的环境中表现尤为出色，更强的信号接收能力能够有效提升捕获质量。完整支持数据包注入。
...
经典的单频（2.4 GHz）芯片组，在无线安全工具领域有着悠久的历史。`ath9k_htc` 驱动程序已内置于内核，经过长期验证，稳定性极佳。数据包注入支持可靠，跨内核版本兼容性一致。尽管仅覆盖 2.4 GHz 频段，在老旧网络测试场景中仍是值得信赖的选择。
...
| AWUS036AXML | MT7921AU | 2.4 / 5 / 6 GHz | ✅ 完整支持（需内核 5.18+） |
| AWUS036ACM | MT7612U | 2.4 / 5 GHz | ✅ 完整支持 |
| AWUS036NHA | AR9271 | 2.4 GHz | ✅ 完整支持 |
| AWUS036NH | RTL8187 | 2.4 GHz | ✅ 完整支持 |
| AWUS1900 | RTL8814AU | 2.4 / 5 GHz | ✅ 完整支持 |
