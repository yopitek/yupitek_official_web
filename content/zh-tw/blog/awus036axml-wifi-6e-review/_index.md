...
實測結果顯示，AWUS036AXML 在距目標基地台合理範圍內，封包注入成功率穩定維持在 90% 以上。MT7921AUN 驅動程式在核心 6.x 上的注入實作相當穩固——明顯優於早期 5.18/5.19 版本，後者在持續注入過程中偶有掉幀現象。
...
| 完整支援監聽模式與封包注入 | MT7921AUN 驅動程式較新，邊緣案例仍可能存在 |
